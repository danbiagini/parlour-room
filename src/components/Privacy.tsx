...
const Privacy: React.FC = () => {
    ...
    <Container>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Pandemic Parlour.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Pandemic Parlour, accessible from{" "}
            <a
              href="https://www.pandemicparlour.com"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://www.pandemicparlour.com
            </a>
          </p>
        </li>
        <li>
      ...
      <h1>Your California Privacy Rights (California&rsquo;s Shine the Light law)</h1>
      <p>
      ...
      <p>
        If you&rsquo;d like to request more information under the California Shine the Light law,
      ...
      <p>
        ...
        a third party link, You will be directed to that third party&rsquo;s site. We strongly
      ...
      <ul>
        <li>By email: pandemic-parlor@googlegroups.com</li>
      </ul>
    </Container>
  );
};
